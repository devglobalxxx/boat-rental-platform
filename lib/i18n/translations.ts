...
const en: T = {
  ...
  home: {
    ...
    subtitle: '200+ verified boats across 48 destinations. Licensed skippers, instant booking, secure payments.',
    searchPlaceholder: 'Where do you want to sail?',
    searchBtn: 'Search boats',
    trustBar: ['200+ Verified boats', '48 Destinations', '4.9★ Rating', 'Instant booking'],
    ...
    steps: [
      { title: 'Search & discover', desc: 'Browse 200+ verified boats across 48 destinations. Filter by type, size, price and date.' },
  ...
  footer: {
    ...
    ctaSub: 'Browse 200+ verified boats across 48 destinations. Instant confirmation, licensed skippers, secure payments.',
    ctaBtn: 'Browse All Boats',
    ctaBtnSecondary: 'List Your Boat',
    trustBadges: ['🔒 Secure payments', '⭐ 4.9 rating', '✅ Verified boats'],
...
const de: T = {
  ...
  home: {
    ...
    subtitle: '200+ verifizierte Boote in 48 Destinationen. Lizenzierte Skipper, Sofortbuchung, sichere Zahlung.',
    searchPlaceholder: 'Wohin möchten Sie segeln?',
    searchBtn: 'Boote suchen',
    trustBar: ['200+ Verifizierte Boote', '48 Destinationen', '4,9★ Bewertung', 'Sofortbuchung'],
    ...
    steps: [
      { title: 'Suchen & entdecken', desc: 'Stöbern Sie durch 200+ verifizierte Boote in 48 Destinationen. Nach Typ, Größe, Preis und Datum filtern.' },
  ...
  footer: {
    ...
    ctaSub: '200+ verifizierte Boote in 48 Destinationen. Sofortbestätigung, lizenzierte Skipper, sichere Zahlung.',
    ctaBtn: 'Alle Boote durchsuchen',
    ctaBtnSecondary: 'Boot eintragen',
    trustBadges: ['🔒 Sichere Zahlung', '⭐ 4,9 Bewertung', '✅ Verifizierte Boote'],
...
const fr: T = {
  ...
  home: {
    ...
    subtitle: '200+ bateaux vérifiés dans 48 destinations. Skippers agréés, réservation instantanée, paiement sécurisé.',
    searchPlaceholder: 'Où souhaitez-vous naviguer ?',
    searchBtn: 'Rechercher des bateaux',
    trustBar: ['200+ Bateaux vérifiés', '48 Destinations', '4,9★ Note', 'Réservation instantanée'],
    ...
    steps: [
      { title: 'Cherchez & découvrez', desc: 'Parcourez 200+ bateaux vérifiés dans 48 destinations. Filtrez par type, taille, prix et date.' },
  ...
  footer: {
    ...
    ctaSub: '200+ bateaux vérifiés dans 48 destinations. Confirmation instantanée, skippers agréés, paiements sécurisés.',
    ctaBtn: 'Voir tous les bateaux',
    ctaBtnSecondary: 'Listez votre bateau',
    trustBadges: ['🔒 Paiements sécurisés', '⭐ Note 4,9', '✅ Bateaux vérifiés'],
...
const ar: T = {
  ...
  home: {
    ...
    subtitle: 'أكثر من 200 قارب موثق في 48 وجهة. ربابنة مرخصون، حجز فوري، مدفوعات آمنة.',
    searchPlaceholder: 'أين تريد الإبحار؟',
    searchBtn: 'ابحث عن القوارب',
    trustBar: ['200+ قارب موثق', '48 وجهة', '4.9★ تقييم', 'حجز فوري'],
    ...
    steps: [
      { title: 'ابحث واكتشف', desc: 'تصفح أكثر من 200 قارب موثق في 48 وجهة. فلتر حسب النوع والحجم والسعر والتاريخ.' },
  ...
  footer: {
    ...
    ctaSub: 'أكثر من 200 قارب موثق في 48 وجهة. تأكيد فوري، ربابنة مرخصون، مدفوعات آمنة.',
    ctaBtn: 'تصفح جميع القوارب',
    ctaBtnSecondary: 'أضف قاربك',
    trustBadges: ['🔒 مدفوعات آمنة', '⭐ تقييم 4.9', '✅ قوارب موثقة'],
...
const ru: T = {
  ...
  home: {
    ...
    subtitle: '200+ проверенных яхт в 48 направлениях. Лицензированные шкиперы, мгновенное бронирование, безопасная оплата.',
    searchPlaceholder: 'Куда вы хотите отправиться?',
    searchBtn: 'Найти яхту',
    trustBar: ['200+ проверенных яхт', '48 направлений', '4,9★ рейтинг', 'Мгновенное бронирование'],
    ...
    steps: [
      { title: 'Ищите и открывайте', desc: 'Просматривайте 200+ проверенных яхт в 48 направлениях. Фильтруйте по типу, размеру, цене и дате.' },
  ...
  footer: {
    ...
    ctaSub: '200+ проверенных яхт в 48 направлениях. Мгновенное подтверждение, лицензированные шкиперы, безопасная оплата.',
    ctaBtn: 'Смотреть все яхты',
    ctaBtnSecondary: 'Добавить яхту',
    trustBadges: ['🔒 Безопасная оплата', '⭐ Рейтинг 4,9', '✅ Проверенные яхты'],
...
const sv: T = {
  ...
  home: {
    ...
    subtitle: '200+ verifierade båtar i 48 destinationer. Licensierade skeppare, direktbokning, säkra betalningar.',
    searchPlaceholder: 'Vart vill du segla?',
    searchBtn: 'Sök båtar',
    trustBar: ['200+ Verifierade båtar', '48 Destinationer', '4,9★ Betyg', 'Direktbokning'],
    ...
    steps: [
      { title: 'Sök & upptäck', desc: 'Bläddra bland 200+ verifierade båtar i 48 destinationer. Filtrera på typ, storlek, pris och datum.' },
  ...
  footer: {
    ...
    ctaSub: '200+ verifierade båtar i 48 destinationer. Omedelbar bekräftelse, licensierade skeppare, säkra betalningar.',
    ctaBtn: 'Se alla båtar',
    ctaBtnSecondary: 'Lista din båt',
    trustBadges: ['🔒 Säkra betalningar', '⭐ Betyg 4,9', '✅ Verifierade båtar'],
...
const nl: T = {
  ...
  home: {
    ...
    subtitle: '200+ geverifieerde boten in 48 bestemmingen. Gediplomeerde schippers, directe boeking, veilige betaling.',
    searchPlaceholder: 'Waar wilt u varen?',
    searchBtn: 'Zoek boten',
    trustBar: ['200+ Geverifieerde boten', '48 Bestemmingen', '4,9★ Beoordeling', 'Directe boeking'],
    ...
    steps: [
      { title: 'Zoek & ontdek', desc: 'Blader door 200+ geverifieerde boten in 48 bestemmingen. Filter op type, grootte, prijs en datum.' },
  ...
  footer: {
    ...
    ctaSub: '200+ geverifieerde boten in 48 bestemmingen. Directe bevestiging, gediplomeerde schippers, veilige betalingen.',
    ctaBtn: 'Bekijk alle boten',
    ctaBtnSecondary: 'Zet uw boot in',
    trustBadges: ['🔒 Veilige betalingen', '⭐ Beoordeling 4,9', '✅ Geverifieerde boten'],
...
const pl: T = {
  ...
  home: {
    ...
    subtitle: '200+ zweryfikowanych łodzi w 48 destynacjach. Licencjonowani kapitanowie, natychmiastowa rezerwacja, bezpieczne płatności.',
    searchPlaceholder: 'Dokąd chcesz popłynąć?',
    searchBtn: 'Szukaj łodzi',
    trustBar: ['200+ Zweryfikowanych łodzi', '48 Destynacji', '4,9★ Ocena', 'Natychmiastowa rezerwacja'],
    ...
    steps: [
      { title: 'Szukaj i odkrywaj', desc: 'Przeglądaj 200+ zweryfikowanych łodzi w 48 destynacjach. Filtruj według typu, rozmiaru, ceny i daty.' },
  ...
  footer: {
    ...
    ctaSub: '200+ zweryfikowanych łodzi w 48 destynacjach. Natychmiastowe potwierdzenie, licencjonowani kapitanowie, bezpieczne płatności.',
    ctaBtn: 'Przeglądaj łodzie',
    ctaBtnSecondary: 'Dodaj swoją łódź',
    trustBadges: ['🔒 Bezpieczne płatności', '⭐ Ocena 4,9', '✅ Zweryfikowane łodzie'],
