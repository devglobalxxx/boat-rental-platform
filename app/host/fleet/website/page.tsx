...
export default async function WebsiteImportPage({ searchParams }: { searchParams: Promise<{ host?: string }> }) {
  ...
  return <WebsiteImportClient locations={locations ?? []} targetHostId={targetHostId} targetLabel={targetLabel} />
}
