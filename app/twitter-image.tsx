  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        <div
          style={{
            fontSize: '56px', fontWeight: 800, color: '#f4f4f2',
        ...
        <div
          style={{
            fontSize: '24px', color: 'rgba(244,244,242,0.60)',
        ...
        <div
          style={{
            ...
            fontSize: '16px', color: 'rgba(244,244,242,0.35)', fontWeight: 500, display: 'flex',
          }}
        >
          boathire24.com
        </div>
