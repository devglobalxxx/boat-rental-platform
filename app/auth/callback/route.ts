...
<tr><td style="padding-bottom:24px;text-align:center;"><span style="font-size:22px;font-weight:800;color:#f4f4f2;">Boat<span style="color:#c9a84e;">Hire24</span></span></td></tr>
...
<tr><td style="padding:8px 12px;border-bottom:1px solid rgba(255,255,255,0.05);"><span style="font-size:11px;color:#c9a84e;font-weight:700;text-transform:uppercase;letter-spacing:0.08em;">${label}</span></td>
...
<div style="text-align:center;"><a href="https://boathire24.com/admin" style="display:inline-block;padding:12px 28px;border-radius:99px;background:linear-gradient(135deg,#d4b05e,#c9a84e,#b8942e);color:#07101e;font-size:14px;font-weight:700;text-decoration:none;">Open Admin Panel →</a></div>
</div></td></tr>
