    ...
    <div className="min-h-screen flex items-center justify-center px-4" style={{ background: '#07101e' }}>
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold mt-4" style={{ color: '#f4f4f2' }}>Create your account</h1>
          <p className="mt-1 text-sm" style={{ color: 'rgba(244,244,242,0.50)' }}>Start booking boats worldwide</p>
        </div>
